...
inline bool cm(pll a, pll b) { if (a.ff == b.ff)return a.ss < b.ss; return a.ff > b.ff; }
...
// temlate <class T> inline T gcd(T a, T b) {if (b == 0)return a; return gcd(b, a % b);}
// temlate <class T> inline T lcm(T a, T b) {return a * b / gcd<T>(a, b);}
// temlate <class T> inline T power(T b, T p) {ll ans = 1; while (p--) ans *= b; return ans;}
